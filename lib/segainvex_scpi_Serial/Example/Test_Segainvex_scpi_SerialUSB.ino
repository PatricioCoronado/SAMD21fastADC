// Test_Segainvex_scpi_SerialUSB.ino
// Ejemplo de uso de la librería segainvex_scpi_Serial para comunicar un PC con Arduino a través del
// puerto serie "SerialUSB" 
// ¡¡¡ IMPORTANTE !!! Hay que editar segainvex_scpi_Serial.h, descomentar el  #define SERIALUSB y comentar el //#define SERIAL1
#include <Arduino.h>
